...
Fork the repository
Create a new branch (git checkout -b new-template)
Add your template to the templates/ directory
Update the README.md file to include your new template in the list of templates
Commit your changes (git commit -am 'Add new template')
Push to the branch (git push origin new-template)
